...
namespace Geo.App_Start
{
    public class TestController : Controller
    {
        ...
        public static ApplicationUser LoadSampleUser(string login, string password, string email)
        {
        ...
        public static void LoadSampleUser(ApplicationUser applicationUser)
        {
        ...
        public static void LoginOut(string login)
        {
            db.Users.Remove(db.Users.First(x => x.UserName == login));
        }


        public static void Setname(string login)
        {
            var perem = db.Users.First();
            db.Users.Remove(perem);
            perem.UserName = login;
            db.Users.Add(perem);
        }
    }
}